...
import torch
from RobustDNN_IMA_bn import IMA_loss, IMA_check_margin, IMA_update_margin, estimate_accuracy_from_margin, plot_margin_hist
...
#%%
    ...
    parser.add_argument('--noise', default=3.0, type=float)  # 3.0L2
